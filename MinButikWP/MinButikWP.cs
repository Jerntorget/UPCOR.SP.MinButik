...
namespace UPCOR.SP.MinButik.MinButikWP
{
                    ...
                    if (items == null) {
                        ...
                        if (items.Count < 10) {
                            foreach (SPListItem item in items) {
                                ...
                                string agare = (string)item["_x00c4_gare"];
                                string adress = (string)item["Adress"];
                                ...
                                SPFieldLookupValueCollection kontakter = (SPFieldLookupValueCollection)item["Kontaktperson"];
